...
/**
 * Periodically triggers all telemetry producers to generate a continuous
 * stream of traces, metrics, and log records.
 *
 * <p>Runs every 5 seconds after a 10-second initial delay. Each cycle:
 * <ul>
 ...
 *   <li>Demonstrates context propagation via {@link ContextPropagationService}</li>
 * </ul>
 */
...
public class DemoSchedulerService {
    ...
    void activate() {
        ...
        scheduler.scheduleAtFixedRate(this::runCycle, 10, 5, TimeUnit.SECONDS);
    }
    ...
    private void runCycle() {
        try {
            ...
            // Logs
            logProducer.logBusinessEvent("demo.cycle.completed", Map.of(
                    "operation", operation,
                    "timestamp", Instant.now().toString()));

            // JDBC
            long id = jdbcService.insertEvent(operation,
                    "Cycle at " + Instant.now());
