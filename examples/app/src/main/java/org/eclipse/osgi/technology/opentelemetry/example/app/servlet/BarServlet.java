...
@Component(
    ...
    immediate = true,
    property = {
        "osgi.http.whiteboard.servlet.pattern=/bar/*",
        "osgi.http.whiteboard.servlet.name=BarServlet",
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (pathInfo != null && pathInfo.startsWith("/slow")) {
            ...
            resp.getWriter().write(
                    "{\"service\":\"bar\",\"mode\":\"slow\",\"duration\":500}");
        } else {
            resp.getWriter().write(
                    "{\"service\":\"bar\",\"items\":[\"bar-1\",\"bar-2\",\"bar-3\"]}");
        }
    }
}
