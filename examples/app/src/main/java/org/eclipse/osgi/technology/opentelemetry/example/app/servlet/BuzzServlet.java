...
@Component(
    ...
    immediate = true,
    property = {
        "osgi.http.whiteboard.servlet.pattern=/buzz/*",
        "osgi.http.whiteboard.servlet.name=BuzzServlet",
...
public class BuzzServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        resp.getWriter().write(
                "{\"service\":\"buzz\",\"counter\":" + counter.incrementAndGet()
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        resp.setCharacterEncoding("UTF-8");
        resp.getWriter().write(
                "{\"service\":\"buzz\",\"echo\":\"" + escapeJson(body) + "\"}");
    }
