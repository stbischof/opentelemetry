...
/**
 * Demonstrates W3C TraceContext propagation between a simulated
 * producer and consumer using the OpenTelemetry Context API.
 *
 * <p>Demonstrates:
 * <ul>
...
public class ContextPropagationService {
    ...
    public void demonstratePropagation() {
        ...
        if (t == null || otel == null) return;

        // Producer side: create span and inject context
        Span producerSpan = t.spanBuilder("example.producer")
        ...
        Span consumerSpan = t.spanBuilder("example.consumer")
