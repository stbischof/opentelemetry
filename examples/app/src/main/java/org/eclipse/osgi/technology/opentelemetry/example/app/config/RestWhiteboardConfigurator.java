...
public class RestWhiteboardConfigurator {
    ...
    void activate() throws IOException {
        rest1Config = createRestConfig("rest1",
                "REST Whiteboard 1", "rest1", "(id=http1)");
        rest2Config = createRestConfig("rest2",
                "REST Whiteboard 2", "rest2", "(id=http2)");
    }
    ...
    private Configuration createRestConfig(String name,
            String displayName, String contextPath, String httpTarget) throws IOException {
        Configuration config = configAdmin.getFactoryConfiguration(
                "JakartarsServletWhiteboardRuntimeComponent", name, "?");
