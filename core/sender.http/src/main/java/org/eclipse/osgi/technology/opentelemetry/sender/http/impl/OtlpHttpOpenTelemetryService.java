...
public class OtlpHttpOpenTelemetryService extends org.eclipse.osgi.technology.opentelemetry.commons.AbstractOpenTelemetryService {
    ...
    private OpenTelemetrySdk buildSdk(BundleContext context, OtlpHttpOpenTelemetryConfiguration config) {
        ...
        SdkTracerProvider tracerProvider = SdkTracerProvider.builder()
            ...
            .addSpanProcessor(BatchSpanProcessor.builder(spanBuilder.build())
                ...
                .setMaxQueueSize(config.spanMaxQueueSize())
                .build())
            .build();
        ...
        SdkMeterProvider meterProvider = SdkMeterProvider.builder()
            ...
            .registerMetricReader(PeriodicMetricReader.builder(metricBuilder.build())
                .setInterval(toDuration(config.metricExportInterval()))
                .build())
            .build();
        ...
        SdkLoggerProvider loggerProvider = SdkLoggerProvider.builder()
            ...
            .addLogRecordProcessor(BatchLogRecordProcessor.builder(logBuilder.build())
                ...
                .setMaxExportBatchSize(config.logMaxExportBatchSize())
                .build())
            .build();
